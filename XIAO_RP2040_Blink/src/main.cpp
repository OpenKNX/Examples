...
void progLedOff()
{
    SerialUSB.println("ProgMode OFF");
    pixels.clear();
    pixels.show();
}
void progLedOn()
{
    SerialUSB.println("ProgMode ON");
...
{
    ledActive = go.value();
    SerialUSB.print("Switch Callback ");
    SerialUSB.println(go.value() ? "True" : "False");
}
...
void setup()
{
    ...
    if (knx.configured())
    {
        ...
        SerialUSB.println("Callbacks linked");
    } else {
        SerialUSB.println("Nicht konfiguriert!");
    }
